...
.logo img {
    ...
    opacity: 1;
    background: linear-gradient(to bottom right, #00f2ff80 0%, #02d1d880 50%, #00f2ff 100%);
    padding: 1px;
...
.logo-nav-bar {
    ...
    height: calc(100% - 0px);
    width: 100%;
    background: linear-gradient(to bottom right, #00f2ff80 0%, #02d1d880 50%, #00f2ff 100%);    backdrop-filter: blur(5px);
    z-index: 1004;
